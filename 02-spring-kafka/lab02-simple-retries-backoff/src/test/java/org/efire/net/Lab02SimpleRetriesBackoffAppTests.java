...
@DirtiesContext
@EmbeddedKafka(topics = AppConstant.LAB02_TOPIC, partitions = 3)
public class Lab02SimpleRetriesBackoffAppTests {
    ...
    void consumeMessageGivenThrowAnExceptionExpectHandleError() throws InterruptedException {
        ...
        kafkaTemplate.send(AppConstant.LAB02_TOPIC, "TEST DEFAULT ERROR HANDLER with Retries and Backoff");
